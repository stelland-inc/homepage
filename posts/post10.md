...
특히, 세계 1억DL의 제작 앱 'MediBang Paint'가 가지는 크리에이터 기반과 스텔라앤이 가진 본고장의 제작 노하우를 곱해 수강생의 창작 활동을 강력하게 지원할 예정이라고 한다. 이번 프로젝트를 제대로 완수한 크리에이터는 담당 프로듀서의 지원 아래 글로벌 웹툰 작가로서 데뷔를 목표로 작품 제작하는 기회도 얻을 수 있을 거라고 말하고 있다. 
